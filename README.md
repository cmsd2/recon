...
a faithful transcription of its source.
...
660 across the suites above, plus nine unit tests inside `recon-core` and six doctests — four
`compile_fail`, on the link, detector and total-order-log ports and on narrating without a
vocabulary, and two worked examples of a storage slot — 675 in total,
